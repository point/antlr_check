...
public interface CorundumListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterDynamic(CorundumParser.DynamicContext ctx);
	/**
	 * Exit a parse tree produced by {@link CorundumParser#dynamic}.
	 * @param ctx the parse tree
	 */
	void exitDynamic(CorundumParser.DynamicContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterId(CorundumParser.IdContext ctx);
	/**
	 * Exit a parse tree produced by {@link CorundumParser#id}.
	 * @param ctx the parse tree
	 */
	void exitId(CorundumParser.IdContext ctx);
	/**
